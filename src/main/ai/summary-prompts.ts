  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "5. 非证据字段不得出现英文。",
        "6. 控制输出规模：场景列表最多 12 项；关键事件、人物状态、人物认知边界、关系动态、伏笔与线索、可核对事实各最多 20 项；连续性风险最多 12 项；每项证据短句最多 2 条。",
        "7. 优先保留影响后文连续性、人物状态、人物认知、伏笔、道具状态、设定规则和因果链的高价值信息，不要机械重复同一事实。",
        "章节正文：",
  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "控制输出规模：片段关键事件、人物状态、空间与行动逻辑、限制与否定事实、可核对事实、伏笔与线索各最多 12 项；连续性风险最多 8 项；每项证据短句最多 2 条。不要为了填字段重复同一事实。",
        "必须记录当前片段内明确出现的空间移动、行动起止、限制条件、否定事实和不能成立的信息；没有原文依据时用空数组，不要照抄示例占位。",
        "片段正文：",
  ...
  return [
    {
      ...
      content: [
        ...
        "控制输出规模：场景列表最多 16 项；关键事件、人物状态、人物认知边界、关系动态、伏笔与线索、可核对事实各最多 24 项；连续性风险最多 16 项；每项证据短句最多 2 条。",
