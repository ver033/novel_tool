  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "5. 控制输出规模，人物最多 30 个，关系事件最多 45 条；优先保留亲缘、师生、同门、主仆、敌对、盟友、交易、压制、保护、背叛、暧昧等对作者后续写作有持续价值的关系，不要枚举一次性擦肩而过的弱互动。",
        "6. 若称呼词无法确认指向哪个已有人物，写入不确定项；不要为了合并而猜测。",
        "7. 若本章没有可靠关系事件，人物可以保留，关系事件输出空数组。",
        "8. 证据短句必须短，每条证据尽量不超过 24 个汉字，不要复制长段正文。",
        "章节正文：",
